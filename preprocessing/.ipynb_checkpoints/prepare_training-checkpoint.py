...
msks = []
for ym in yms:
    fpath = f"/home/jovyan/lustre_scratch/cas/rep_learning/weather2vec/data/SO4/tif/{ym}.tif"
...
msks = []
for ym in yms:
    fpath = f"/home/jovyan/lustre_scratch/cas/rep_learning/weather2vec/data/weather/{ym}.tif"
    with rasterio.open(fpath) as src:
        msk = src.read_masks()
        msk = (msk > 0).astype(np.float32)
        rast = src.read() * msk
...
pp = pd.read_csv("/home/jovyan/lustre_scratch/cas/rep_learning/weather2vec/data/so2_data_full.csv")
...
#%%
with open("/home/jovyan/lustre_scratch/cas/rep_learning/weather2vec/data/weather_names.csv", "r") as f:
...
with open("/home/jovyan/lustre_scratch/cas/rep_learning/weather2vec/data/training_data.pkl", "wb") as io:
